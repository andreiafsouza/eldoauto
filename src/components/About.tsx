      ...
      <div className="section max-w-[84rem] px-4 mx-auto grid grid-cols-1 gap-4 lg:grid-cols-2 lg:gap-12">
        <div>
          <div className="text-center lg:text-right">
            <h1 className="font-semibold text-5xl lg:text-6xl text-sky-300">
              Nossa História
            </h1>
            ...
            <div className="p-4">
              <h2 className="text-lg text-sky-300">
                <button
                  ...
                  className="w-full pb-2 flex items-center justify-center opacity-90 hover:opacity-100 leading-relaxed border-b-[1px] lg:justify-end"
              ...
              >
                <div className="overflow-hidden pt-2 text-left">
                  <p>
                    A trajetória da Eldorado Automóveis é marcada por momentos
                    de muita dedicação e inspiração. Fundada por um casal
                    visionário, José Coura e Sônia Coura, a empresa teve suas
                    raízes estabelecidas no bairro Novo Eldorado, onde começaram
                    aos poucos e de forma modesta a construir o que a empresa é
                    hoje. O casal, apaixonado por carros e com habilidades
                    complementares em mecânica e gestão, decidiu unir forças
                    para criar um espaço que pudesse não apenas reparar os danos
                    mecânicos dos veículos, mas também elevar o seu padrão
                    estético com um acabamento de alto nível em lanternagem e
                    pintura. A dedicação e a vontade de servir com excelência
                    seus clientes foram os motores que impulsionaram o
                    crescimento da Eldorado Automóveis Lanternagem & Pintura.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="pt-6 flex flex-col justify-center">
          {valuesList.map((e, index) => {
            return (
              <div
                key={index}
                className="mb-4 flex-1 flex flex-col gap-4 py-4 px-4 border-sky-300 border-l-2 border-dotted"
              >
