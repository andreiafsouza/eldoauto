    ...
    <a
      className={
        variant && variant === "btn"
          ...
          : "text-xl md:text-base drop-shadow-lg opacity-90 hover:opacity-100 focus-visible:opacity-100 hover:text-sky-300 focus-visible:hover:text-sky-300 transition-colors"
      }
      {...props}
    >
      {props.children}
